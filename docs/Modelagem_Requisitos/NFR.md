...
<i>Figura 4: NFR de usabilidade, sem propagação. Autor: Luis Marques.</i>

### Com propagação
<img alt= "caso-de-uso-4" src="../images/NFR/usabili_propag.png" width = "900" />

<i>Figura 5: NFR de usabilidade, com propagação. Autor: Luis Marques.</i>
...
<i>Figura 6: NFR de confiabilidade, sem propagação. Autor: Luis Marques.</i>

### Com propagação

<img alt= "caso-de-uso-4" src="../images/NFR/confiabilidade_propag.png" width = "900" />

<i>Figura 7: NFR de confiabilidade, com propagação. Autor: Luis Marques.</i>
...
<i>Figura 8: NFR de desempenho, sem propagação. Autor: Luis Marques.</i>

### Com propagação

<img alt= "caso-de-uso-4" src="../images/NFR/desempenho_propag.png" width = "900" />

<i>Figura 9: NFR de desempenho, com propagação. Autor: Luis Marques.</i>
